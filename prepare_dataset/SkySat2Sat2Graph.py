...
for rid in range(len(regionname)):
	...
	# copy other files 
	Popen("cp "+regionname[rid] + "_gt.png "+ sat2graph_folder+"/region_%d_refine_gt_graph.p" % rid, shell=True)
	Popen("cp "+regionname[rid] + "_gt_graph_samplepoints.json "+ sat2graph_folder+"/region_%d_gt_graph_samplepoints.json" % rid, shell=True)
